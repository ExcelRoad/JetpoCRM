...
urlpatterns = [
    ...
    path('api/quote-export/', views.quote_export, name='quote-export'),
    path('import-template/', views.quote_import_template, name='quote-import-template'),
    path('api/import-preview/', views.quote_import_preview, name='quote-import-preview'),
    path('import-confirm/', views.quote_import_confirm, name='quote-import-confirm'),
