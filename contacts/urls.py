...
urlpatterns = [
    ...
    path('import-template/', views.contact_import_template, name='contact-import-template'),
    path('api/import-preview/', views.contact_import_preview, name='contact-import-preview'),
    path('import-confirm/', views.contact_import_confirm, name='contact-import-confirm'),
